...
This project was supposeto be a collaborative effort but was done solely by me. I extensively explored various tree data structures. This involved learning about their classifications, traversal methods, and practical implementations. The journey encompassed binary, binary search, AVL, and Max Binary Heap trees. The project deepened my understanding of trees as versatile tools in computer science, providing hands-on experience and insights into their applications and advantages.
...
* **34. AVL - From sorted array**
  * [124-sorted_array_to_avl.c](./124-sorted_array_to_avl.c): C function that builds an AVL tree     from a sorted array.
...
* **36. Is Binary Heap**
  * [120-binary_tree_is_heap.c](./130-binary_tree_is_heap.c): C function that checks if a binary tree is a valid Max Binary Heap.
  * The function returns 1 if the tree is a valid Max Binary Heap, and 0 otherwise.
  * An empty tree is considered a valid Max Binary Heap.

* **37. Heap - Insert**
  * [121-heap_insert.c](./131-heap_insert.c): C function that inserts a value into a max binary heap.
  * The function inserts the value into the max binary heap and reorganizes the heap as needed.
  * Returns a pointer to the inserted node, or NULL on failure.

* **38. Heap - Array to Binary Heap**
  * [125-array_to_heap.c](./132-array_to_heap.c): C function that converts an array into a binary heap.
  * The function converts the array into a binary heap (max heap).
  * Returns the total number of comparisons made while rearranging the array.

* **39. Heap - Extract**
  * [126-heap_extract.c](./133-heap_extract.c): C function that extracts the root node value of a max binary heap.
  * The function extracts the root value from the heap and reorganizes the heap as needed.
  * Returns the extracted value.

* **40. Heap - Sort**
  * [127-heap_sort.c](./134-heap_to_sorted_array.c): C function that sorts an array of integers in ascending order using the heap sort algorithm.
  * size is the number of elements in the array.
  * The function sorts the array using the heap sort algorithm.
...
* __Kriss Igebu__ <[KSI](https://github.com/KSI5)>
